  ...
  return (
    <div>
      <p className="mt-1">
        ...
        <span className="text-blue-500 cursor-pointer" onClick={()=>chrome.tabs.create({url: 'chrome://extensions/shortcuts', active: !0, selected: !0})}>{OS?'⌥':'Alt'} + ↓↑</span>
      </p>
      ...
      <div>
        ...
        {tabs.map((e, n) => (
          <div
            ...
            onClick={()=>{
              chrome.tabs.update(e.id, {active: true}, function(e){
